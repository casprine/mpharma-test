...
import { seed, addItem, editItem, deleteItem } from './action/products';
...
const Product = ({ prices, name, onEdit, onDelete }) => {
  return (
...
function App({ addItem, seedStore, products, deleteItem, editItem }) {
